                      ...
                      <Select onValueChange={handleProviderChange} value={formData.provider} name='provider'>
                        ...
                        <SelectContent className='border-gray-600 border-2 bg-black text-white font-semibold'>
                          <SelectGroup>
                            ...
                            <SelectItem value='icd'>Indian-camp/JMD</SelectItem>
                          </SelectGroup>
                        </SelectContent>
                      </Select>
                    </div>
                ...
                >
                  ...
                  <TableCell>
                    <div className="flex gap-2 items-center">
                      <Button className='bg-transparent hover:bg-[#A855F7]' onClick={()=>copyUrl(`https://offer.twcampaign.in/campaign/${camp._id}`)}><Share2 className='color-white hover:color-black'/></Button>
                      <Switch
