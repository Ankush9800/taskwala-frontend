                ...
                >
                  ...
                  <TableCell>
                    <div className="flex gap-2 items-center">
                      <Button className='bg-transparent hover:bg-[#A855F7]' onClick={()=>copyUrl(`https://twcampaign.in/campaign/${camp._id}`)}><Share2 className='color-white hover:color-black'/></Button>
                      <Switch
