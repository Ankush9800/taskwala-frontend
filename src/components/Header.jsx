        ...
        <div className="md:hidden">
            ...
            menuOpen ? "translate-x-0" : "translate-x-full"
                ...
                <div className="flex justify-end border-b-2 border-[#5d6167] pb-2">
                    ...
                    <img src="https://res.cloudinary.com/dlrx3a4lp/image/upload/v1752334083/assets/cross_kxvqu2.svg"/>
                </li>
                </div>
                <li><NavLink to={"/"} className={({isActive})=>(
                    `${isActive?"text-[#F97316]":"text-[#F5F5F5]"} text-md font-semibold hover:text-[#F97316] transition-all duration-300`
        ...
        <div>
            <ul>
                <li>
                    ...
                    <Button className="bg-transparent hover:bg-transparent cursor-pointer md:hidden" onClick={() => setMenuOpen(true)}><img src="https://res.cloudinary.com/dlrx3a4lp/image/upload/v1752334083/assets/menu_vezvwf.svg"/></Button>
                </li>
